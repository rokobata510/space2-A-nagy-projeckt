<div class="w-full max-w-xl mx-auto my-5 overflow-hidden border border-pink-800 shadow-xl px-14 py-14 sm:rounded-lg bg-gradient-to-r from-black to-pink-500">
    ...
    <form method="POST" action="http://localhost:8000/register">
        ...
        <div class="flex items-center justify-end mt-4">
            <button type="submit" class="inline-flex items-center px-4 py-2 ml-4 text-xs font-semibold tracking-widest text-pink-400 uppercase transition duration-150 ease-in-out border border-transparent rounded-md bg-neutral-900 hover:bg-gray-700 focus:bg-gray-700 active:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
                Register
            </button>
        </div>
    </form>
